...
$sql = 'SELECT m.user, m.picture, p.* FROM members m, posts p ORDER BY posts p DESC;WHERE m.id=p.member_id LIMIT :start, :list';
...
<li><a href="index2.php?page=<?php print(content); ?>">次のページへ</a></li>
<?php
} else {
?>
<li>次のページへ</li>
